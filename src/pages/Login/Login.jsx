...
const Login = () => {
  ...
  console.log("login in the ", location);
  ...
  return (
    <div className="flex justify-center items-center bg-slate-50">
      <div className="w-full max-w-md p-8 space-y-3 bg-amber-100 rounded-lg">
        ...
        <form className="space-y-6">
          ...
          <button
            ...
            className="block w-full p-3 text-center rounded-lg bg-blue-500 text-white font-bold"
          >
            Sign in
          </button>
        </form>
